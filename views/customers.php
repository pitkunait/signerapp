...
<head>
    ...
    <title>Customers | Sign documents online</title>
    ...
    <div class="content">
        <div class="page-title">
            <div class="pull-right page-actions lower">
                <button class="btn btn-primary" data-toggle="modal" data-target="#create" data-backdrop="static" data-keyboard="false"><i class="ion-plus-round"></i> New Customer</button>
            </div>
            <h3>Customers </h3>
            <p>This is a list of your customers.</p>
        </div>
        <div class="row">
            <div class="col-md-12">
