...
<body  class="open_template">
    ...
    <header>
        ...
        <ul class="nav header-links pull-right">
            ...
            <li class="m-o"><button class="btn btn-success accept-request"><i class="ion-ios-checkmark-outline"></i> <span>Accept</span> </button></li>
            <li class="m-o"><button class="btn btn-danger send-to-server-click"  data="requestid:{{ $request->id }}|file:{{ $document->id }}|csrf-token:{{ csrf_token() }}" url="<?=url("Guest@decline");?>" warning-title="Are you sure?" warning-message="This request will be declined and email sent to sender." warning-button="Yes, Decline" loader="true"><i class="ion-ios-close-outline"></i> Decline </button></li>
            @else
                @if($document->public_permissions == "sign_edit")
                <li class="m-o">
                    <button class="btn btn-success btn-responsive launch-editor"><i class="ion-edit"></i> Sign & Edit </button>
                </li>
                @endif
                <li class="m-o">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu public-actions">
                            <li role="presentation"><a data-toggle="modal" data-target="#updateSignature" data-backdrop="static" data-keyboard="false"> <i class="ion-edit"></i> <span>Signature</span></a> </li>
                            <li class="divider"></li>
                            @if ( env('DISABLE_SHARE') != "Enabled" )
                                <li><a data-toggle="modal" data-target="#sharefile" data-backdrop="static" data-keyboard="false"><i class="ion-ios-world-outline"></i><span> Share link</span></a></li>
                                <li class="divider"></li>
                            @endif
    ...
    <div class="signer-overlay">
        <div class="signer-overlay-header">
            ...
            <div class="signer-overlay-action">
                <button class="btn btn-default close-editor-overlay"><i class="ion-ios-close-outline"></i> Close </button>
                <button class="btn btn-primary signer-save"><i class="ion-ios-checkmark-outline"></i> <span>Save</span> </button>
            </div>
            <div class="signer-header-tools">
                <div class="signer-header-tool-holder">
                    ...
                    <div class="signer-tool" tool="editsignature">
