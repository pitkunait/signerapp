...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=B612+Mono:400,400i,700|Charm:400,700|EB+Garamond:400,400i,700|Noto+Sans+TC:400,700|Open+Sans:400,400i,700|Pacifico|Reem+Kufi|M+PLUS+1p|Scheherazade:400,700|Tajawal:400,700&amp;subset=arabic,cyrillic,cyrillic-ext,greek,greek-ext,hebrew,japanese,latin-ext,vietnamese" rel="stylesheet">
    <!-- Bootstrap CSS -->
                        ...
                        <div class="form-group chain-request" style="display: none;">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <br><span class="text-muted text-xs"> Request will be sent to the first email and after it's accepted and signed, it sent to the second email. The chain breaks when it's declined by any recipient.</span>
                                </div>
                            </div>
                        </div>
                        @if ( $user->role != "user" )
